...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/discuss@1.1.10/dist/discuss.js"></script>
  ...
</head>
<body>
  ...
...
<head>
  ...
  <!-- 建议你使用指定版本的js，而不是上方的最新版本，因为后续如果js有更新的话，可能会出现问题 -->
  <script src="https://cdn.jsdelivr.net/npm/discuss@1.1.10/dist/discuss.admin.js"></script>
  ...
</head>
<body>
  ...
...
discuss.init({
  // baomitu (默认内置)
  emotCDN: 'https://lib.baomitu.com/discuss/1.1.10'
  // unpkg
  emotCDN: 'https://unpkg.com/discuss@1.1.10'
  // jsdelivr
  emotCDN: 'https://cdn.jsdelivr.net/npm/discuss@1.1.10'
})
```
