...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/discuss@1.2.3/dist/discuss.js"></script>
  ...
</head>
<body>
  ...
...
discuss.init({
  // baomitu (默认内置)
  emotCDN: 'https://lib.baomitu.com/discuss/1.2.3'
  // unpkg
  emotCDN: 'https://unpkg.com/discuss@1.2.3'
  // jsdelivr
  emotCDN: 'https://cdn.jsdelivr.net/npm/discuss@1.2.3'
})
```
