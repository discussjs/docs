    ...
    <div class="import">
      ...
      <div class="import-item">
        ...
        <textarea
          ...
          placeholder="将waline评论系统导出的评论信息粘贴至此~"
        ></textarea>
      </div>
      <div class="import-item">
  ...
  methods: {
    ...
    parseCounter() {
      ...
      for (const i of data) {
        ...
        counter.time = i.time
        counter.created = new Date(i.createdAt).getTime()
        counter.updated = new Date(i.updatedAt).getTime()
    ...
    parseComments() {
      ...
      for (const c of data) {
        ...
        comment.avatar = md5(c.mail)
        comment.created = new Date(c.createdAt).getTime()
